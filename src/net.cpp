...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("middlefinger-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("middlefinger-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "middlefinger " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"54.69.152.10", "54.69.152.10"},
    {"54.69.183.103", "54.69.183.103"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("middlefinger-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("middlefinger-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("middlefinger-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("middlefinger-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. middlefinger is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("middlefinger-start");
